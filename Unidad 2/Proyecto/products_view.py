...
class ProductFormDialog:
    ...
    def create_widgets(self):
        ...
        for label_text, field_name in fields:
            ...
            entry_frame = tk.Frame(main_frame, bg="#636e72", height=2)
            ...
            # Efecto hover
            def on_enter(e, frame=entry_frame):
                frame.config(bg="#74b9ff")
            
            def on_leave(e, frame=entry_frame):
                frame.config(bg="#636e72")
